...
namespace Helper.Functions
{
    ...
    {
        static string ldapPath = System.Web.Configuration.WebConfigurationManager.AppSettings["ADService"].ToString();
        static string ldapDomain = System.Web.Configuration.WebConfigurationManager.AppSettings["LDAPDomain"].ToString();
        //System.Web.Configuration.WebConfigurationManager.ConnectionStrings["LDAPDomain"].ConnectionString;
        static string adminitrator = System.Web.Configuration.WebConfigurationManager.AppSettings["ADAdministrator"].ToString();
        static string ldapIP = System.Web.Configuration.WebConfigurationManager.AppSettings["LDAPIP"].ToString();
        //System.Web.Configuration.WebConfigurationManager.ConnectionStrings["LDAPIP"].ConnectionString;
        static string password = System.Web.Configuration.WebConfigurationManager.AppSettings["ADPassword"].ToString();
        ...
        public static string CreateUserAccount(string userName, string displayName, string userPassword, string email)
        {
