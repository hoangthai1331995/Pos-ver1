...
if (window.require) {
  ...
  function goLoadSrc(filenames) {
    ...
    for (var i = 0; i < arguments.length; i++) {
      ...
      selt.async = false;
      selt.defer = false;
      selt.src = "/Content/Templates/GuruTemplate/assets/pages/flowchart/" + filename;
...
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/Content/Templates/GuruTemplate/assets/pages/flowchart/highlight.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "/Content/Templates/GuruTemplate/assets/pages/flowchart/main.css";
head.appendChild(link);
